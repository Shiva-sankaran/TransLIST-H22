                ...
                with inner_tqdm(total=len(data_iterator), leave=False, dynamic_ncols=True) as pbar:
                    ...
                    for batch_x, batch_y in data_iterator:
                        ...
                        if(flag == 0):
                            continue
                                # pass
                                # temp_lat.append(("*",str(poss[i]),str(pose[i])))
                        ...
                        if(self.status=='test'):
                            ...
                            if(len(batch_y['target'].tolist()) != len(pred_dict['pred'].tolist())):
                                ...
                                temp_target = ''.join(temp1).strip("_").split('_')
                                temp_pred = ''.join(temp2).strip("_").split('_')
                                self.g.write(s+'\n')
                    ...
                    if(self.status=='test'):
                        ...
                        print("Total number of skipped sentences: ",skipping_sents)
